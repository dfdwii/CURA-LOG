...
if (isset($_GET['kembali'])) {
    ...
    // Admin dan Organizer (Staff) boleh mengembalikan milik siapapun
    if ($role == 'dokter' && $data_h['id_user'] != $my_id) {
        echo "<script>alert('Gagal! Anda hanya bisa mengembalikan alat yang Anda pinjam sendiri.'); window.location='history.php';</script>";
    } else {
...
<div class="container-fluid">
    <div class="row">
        <?php include '../tampilan/sidebar.php'; ?>
            ...
            <h3><?php echo ($role == 'dokter') ? 'Histori Peminjaman' : 'Laporan Peminjaman'; ?></h3>
            
            <p class="text-muted">
                <?php echo ($role == 'dokter') ? "Menampilkan riwayat peminjaman pribadi Anda." : "Menampilkan seluruh riwayat peminjaman rumah sakit."; ?>
            </p>
            <hr>
            ...
            <div class="card shadow-sm">
                <div class="card-body p-0">
                    <table class="table table-hover mb-0 align-middle">
                        ...
                        <tbody>
                            <?php
                            // Filter tampilan data berdasarkan role
                            if ($role == 'dokter') {
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <?php } else {
                                        echo '<span class="text-muted small"><i class="bi bi-check2-all"></i> Selesai</span>';
                                    } ?>
                                </td>
                            </tr>
                            <?php } ?>
