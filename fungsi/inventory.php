        ...
        <div class="col-md-10 offset-md-2 px-4 pt-0" style="padding-bottom: 80px;">
            ...
            <div class="sticky-top pt-4 pb-3 mb-3" style="background-color: #f8fafc; z-index: 10;">
                ...
                <form method="GET" class="row g-2 bg-white p-3 rounded shadow-sm border">
                    <div class="col-md-5">
                        <input type="text" name="search" class="form-control" placeholder="Cari nama alat atau merk..." value="<?php echo $search; ?>">
                    </div>
                    <div class="col-md-4">
                ...
                <div class="card-body p-0">
                    <table class="table table-hover align-middle mb-0">
                        ...
                        <tbody>
                            ...
                            $sql = "SELECT * FROM alat $where ORDER BY id_alat DESC";
                            ...
                            ?>
                            <tr>
                                <td class="ps-3"><img src="../assets/img/alat_medis/<?php echo $data['gambar']; ?>" class="img-alat"></td>
